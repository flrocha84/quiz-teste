...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView slectedTopicName = findViewById(R.id.topicName);
        ...
        slectedTopicName.setText(getSelectedTopicName);
    ...
    private void changeNextQuestion() {
        ...
        if (currentQuestionPosition < questionsLists.size()) {
            ...
            option1.setBackgroundResource(R.drawable.round_back_white_stoke2);
            option1.setTextColor(Color.parseColor("#1F6BB8"));
            option2.setBackgroundResource(R.drawable.round_back_white_stoke2);
            option2.setTextColor(Color.parseColor("#1F6BB8"));
            option3.setBackgroundResource(R.drawable.round_back_white_stoke2);
            option3.setTextColor(Color.parseColor("#1F6BB8"));
            option4.setBackgroundResource(R.drawable.round_back_white_stoke2);
        ...
        quizTimer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                if (seconds == 0) {
                    ...
                    quizTimer.purge();
                    quizTimer.cancel();
                    Toast.makeText(QuizActivity.this, "O tempo acabou", Toast.LENGTH_SHORT).show();
    ...
    private void revealAnswer() {
        ...
        explicacao.setText(questionsLists.get(currentQuestionPosition).getExplicacao());
    }
}